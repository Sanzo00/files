...
def plot_stack_bar(plot_params, my_params, Y, labels, xlabel, ylabel, anchor=None, figpath=None):
  # print(plt.rcParams.keys())
    ...
    for i, y in enumerate(Y):
        plt.bar(ind,y,width,color=colors[i], label =labels[i], bottom=pre_bottom, linewidth=params['lines.linewidth'], edgecolor='black')
        pre_bottom += y  
...
if __name__ == '__main__':
  ...
  plot_stack_bar(params, my_params, Y1, labels, xlabel, ylabel, xticks, figpath='stack_bar.pdf')